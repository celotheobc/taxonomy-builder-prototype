...
const TABS = [
  { id: 'objects', label: 'Objects', countKey: 'objects' },
  { id: 'relationships', label: 'Relationships', countKey: 'relationships' },
  { id: 'events', label: 'Event Sources', countKey: 'events' },
  { id: 'metrics', label: 'Metrics', countKey: 'metrics' },
...
export default function BottomPanel({
  ...
  return (
    <section
      ...
      aria-label="Perspective summaries"
    >
        ...
        <div className={styles.body}>
          ...
          {activeTab === 'metrics' && (
            <DataTable
              ...
              rows={metricRows}
              selectedId={selectedRowId}
              empty="No metrics included yet."
              onSelectRow={(row) => onSelectMetric(row.id)}
            />
          )}
