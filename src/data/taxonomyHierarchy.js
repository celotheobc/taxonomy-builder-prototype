...
export const DEMO_HIERARCHIES = {
  ...
  'taxonomy-factory-country': {
    groups: [
      {
        id: 'europe',
        label: 'Europe',
        description: 'European factory locations.',
        parentId: null,
        memberIds: ['france', 'germany', 'italy', 'spain', 'portugal'],
      },
      {
        id: 'northern-europe',
        label: 'Northern Europe',
        description: 'Northern European manufacturing sites.',
        parentId: 'europe',
        memberIds: ['germany'],
      },
      {
        ...
        description: 'Southern European manufacturing sites.',
        parentId: 'europe',
        memberIds: ['italy', 'spain', 'portugal'],
      },
      {
        id: 'asia',
        label: 'Asia',
        description: 'Asian factory locations.',
        parentId: null,
        memberIds: ['japan', 'china', 'thailand'],
      },
    ],
  },
};
